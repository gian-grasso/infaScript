...
routine() {
    #Routines
    clear
    printf "\n${RESET}${txtbgblu}${BOLD}Routine for reduce drain in WIFI:${RESET}\n${txtbggrn}${BOLD}1. Add if ${txtinv}${BOLD}'connected to wifi'${RESET}${txtbggrn}${BOLD}\nand choose a preferred Wifi.\n2. Add then ${txtinv}${BOLD}'switch mobile data to 3g'${RESET}${txtbggrn}${BOLD} and\n${txtinv}${BOLD}'mobile data off'${RESET}${txtbggrn}${BOLD}.\n3. Turn off the ${txtinv}${BOLD}'revert actions'${RESET}${txtbggrn}${BOLD} at the end of routine'.\n4. Save the routine.\n5. Create a second routine: Add\nif ${txtinv}${BOLD}'disconnected to Wifi'${RESET}${txtbggrn}${BOLD}.\n6. Add then ${txtinv}${BOLD}'switch mobile data to 4g/5g'${RESET}${txtbggrn}${BOLD} and\n${txtinv}${BOLD}'turn on mobile data'${RESET}${txtbggrn}${BOLD}.\n7. Turn off the ${txtinv}${BOLD}'revert actions'${RESET}${txtbggrn}${BOLD} at the end of routine.\n8. Save the routine.${RESET}\n${txtbgblu}${BOLD}Enjoy :)${RESET}\n"
